...
```typescript
async function insertField(domain: string, key: string, value: string, providers: PublicDataProviders): Promise<Return<foo>>
```
...
```typescript
async function addMultipleFields(domain: string, fields: Array<[string, string]>, providers: PublicDataProviders): Promise<Return<foo>>
```
...
```typescript
async function clearField(domain: string, key: string, value: string, providers: PublicDataProviders) Promise<Return<foo>>
```
```typescript
...
```typescript
async function clearAllFields(domain: string, providers: PublicDataProviders) Promise<Return<foo>>
```
```typescript
...
```typescript
async function updateDomainTarget(domain: string, target: string, providers: PublicDataProviders) Promise<Return<foo>>
```
```typescript
...
```typescript
async function transferDomainOwnership(parent: string, subdomain: string, new_owner: string, providers: PublicDataProviders) Promise<Return<foo>>
```
...
```typescript
async function changeDomainOwner(domain: string, new_owner: string, providers: PublicDataProviders) Promise<Return<foo>>
```
