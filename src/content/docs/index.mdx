...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Learn how to resolve .night domains to addresses and query profile data using the SDK."
    href="/reference/resolve/"
  />
  <LinkCard
    title="Profile Widget"
    description="Display beautiful domain profiles in your React app with the pre-built widget component."
