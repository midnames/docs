...
Fields appear on your domain profile at <a href="https://midnight.domains" target="_blank">midnight.domains</a> and in any app that uses the `DomainProfileWidget` or calls `getDomainFields` from the SDK.
...
To add, edit, or remove fields, go to <a href="https://midnight.domains" target="_blank">midnight.domains</a>, search for your domain, and click **Customize & Advanced**. From there you can:
