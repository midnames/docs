...
- `my.domain.night` (cannot contain multiple parts separated by dots)
...
- `my_sub.domain.night` (cannot contain underscores or special characters)
- `my..sub.domain.night` (cannot contain consecutive dots)
- `sub..domain.night` (cannot contain consecutive dots)
