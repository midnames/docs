...
In this guide, we will walk you through the steps to buy a `.night` domain using <a href="https://preprod.midnames.com" target="_blank">Midnames</a>, the domain registrar for the Midnight Network.
...
2. Go to <a href="https://preprod.midnames.com" target="_blank">https://preprod.midnames.com</a>
