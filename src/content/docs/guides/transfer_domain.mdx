...
1. **Verify domain ownership**
   ...
   Midnight Domains verifies the ownership of the domain with your current wallet address. Once it is verified, you'll be allowed to transfer ownership to another address.
